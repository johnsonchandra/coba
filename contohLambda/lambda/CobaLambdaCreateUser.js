...
function sendVerificationEmail(email, token, fn) {
	var subject = 'Verification Email for ' + 'jcha Authentication';
	var verificationLink = 'http://cobacoba.s3.amazonaws.com/verify.html' + '?email=' + encodeURIComponent(email) + '&verify=' + token;
	ses.sendEmail({
